    ...
    <div class="row mb-5">
      <div class="filmesItem">
        ...
        <div class="filmesItem">
          <img src="<?php bloginfo('template_directory'); ?>/assets/img/pexels-karley-saagi-2062882.jpg" class="img-fluid">
          <span class="duracao">130m</span>
          <h3>In anim reprehenderit.</h3>
        </div>
        <div class="filmesItem">
          <img src="<?php bloginfo('template_directory'); ?>/assets/img/pexels-perchek-industrie-5451980.jpg" class="img-fluid">
          <span class="duracao">130m</span>
          <h3>In anim reprehenderit.</h3>
        </div>
    </div>